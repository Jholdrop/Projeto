...
<td class="font-weight-medium"><?php echo $usuario["nome"];
?>
</td>
<td class="text-dim"><?php echo $cpf_formatado;
?>
</td>
<td><?php echo $usuario["email"];
?>
</td>
<td><?php echo $usuario["telefone"];
?>
</td>
<td class="text-dim"><?php echo $usuario["cep"];
?>
</td>
<td><?php echo $usuario["numero"];
?>
</td>
<td>
...
?>" class="action-btn-edit" title="Editar Usuário">
...
?>" class="action-btn-delete" title="Excluir Usuário" onclick="return confirm('Deseja realmente excluir o aluno
...
<button type="submit" class="action-btn-edit" onclick="return confirm('Deseja desbloquear o aluno
<?php echo addslashes($usuario['nome']);
?>?');">Desbloquear</button>
</form>
<?php else: ?>
...
<button type="submit" class="action-btn-delete" onclick="return confirm('Deseja bloquear o aluno
<?php echo addslashes($usuario['nome']);
?>?');">Bloquear</button>
</form>
<?php endif; ?>

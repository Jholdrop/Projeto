...
<?php echo $page_active == 'dashboard' ? 'active' : '';
?>">
<span class="nav-icon">
...
<a href="/pages/usuarios/cadastro_usuarios.php" class="nav-link
<?php echo $page_active == 'cadastro' ? 'active' : '';
?>">
<span class="nav-icon">
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
<a href="/pages/usuarios/gerenciamento_usuarios.php" class="nav-link
<?php echo $page_active == 'gerenciamento' ? 'active' : '';
?>">
<span class="nav-icon">
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
<a href="/pages/planos/controle_planos.php" class="nav-link
<?php echo $page_active == 'planos' ? 'active' : '';
?>">
<span class="nav-icon">
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
<a href="/pages/bloqueios/controle_bloqueios.php" class="nav-link
<?php echo $page_active == 'bloqueios' ? 'active' : '';
?>">
<span class="nav-icon">
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">

...
?>
<tr>
<td>#<?php echo $bloqueio["id"];
?>
</td>
<td class="font-weight-medium"><?php echo $bloqueio["nome"];
?>
</td>
<td><?php echo date('d/m/Y H:i', strtotime($bloqueio["data_bloqueio"]));
?>
</td>
<td>
...
<td class="text-dim"><?php echo $bloqueio["motivo"];
?>
</td>
<td>

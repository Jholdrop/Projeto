...
$stmt = $conexao->prepare(" INSERT INTO bloqueados (usuario_id, status, motivo) VALUES (:usuario_id, 'ativo', :motivo) ");
$stmt->execute([ ":usuario_id" => $usuario_id, ":motivo" => $motivo !== "" ? $motivo : "Bloqueio manual" ]); }
if ($acao === "desbloquear") {

    ...
    <div class="login-wrapper">
        ...
        <div class="login-brand-side" style="background-image: url('/assets/img/gym-bg.png');">
            ...
            <div class="login-brand-content">
                ...
                <p class="login-slogan">Mais que uma academia, <br>um <span class="text-primary font-weight-bold">estilo de vida.</span></p>
            </div>
        ...
        <div class="login-form-side">
            ...
            <div class="login-footer">
                <p>© 2024 <span class="text-primary font-weight-bold">Bodyfit</span> Academia. Todos os direitos reservados.</p>
            </div>
            
            <div class="decor-lines-bottom-right"></div>
        </div>
    </div>
